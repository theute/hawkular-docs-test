...
. Start the Cassandra container that you previously downloaded.
+
----
...
docker ps
----
.  View the node information with this command:
+
[source, bash]
----
...
----
+
. Launch the Middleware Manager container and tell it to connect to Cassandra.  Change `my_db_username`, `my_db_password`, and `my_db_host` to the values you
